...
function onAdStarted(event) {
  ...
  console.group('Ad Started Playback');
  console.log(`Ad: Id - ${CurrentAd.getAdId()}`);
  console.log(`Ad: Advertiser - ${CurrentAd.getAdvertiserName() || null}`);
  console.log(`Ad: VAST Media Bitrate - ${CurrentAd.getVastMediaBitrate()}Kbps`);
  console.log(`Ad: Survey URL - ${CurrentAd.getSurveyUrl()}`);
  console.log(`Ad: Trafficking Parameters - ${CurrentAd.getTraffickingParametersString()}`)
